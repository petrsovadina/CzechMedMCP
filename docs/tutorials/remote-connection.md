...
Once authenticated, you'll see a successful connection message displaying the available tool count. As of March 2026, there are 60 tools available including 23 Czech healthcare tools (this number may increase as new features are added).
