...
|---------|--------|-------|
| Standardní | `src/biomcp/individual_tools.py` | 33 |
| České | `src/biomcp/czech/czech_tools.py` | 23 |
| Router | `src/biomcp/router.py` | 2 |
| Think | `src/biomcp/thinking_tool.py` | 1 |
| Metrics | `src/biomcp/metrics_handler.py` | 1 |
