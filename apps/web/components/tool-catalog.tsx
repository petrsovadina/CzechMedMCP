...
const groupColors: Record<string, string> = {
  'SUKL': 'bg-blue-500/10 text-blue-400 border-blue-500/20',
  'MKN-10': 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',
  'NRPZS': 'bg-violet-500/10 text-violet-400 border-violet-500/20',
  'SZV': 'bg-amber-500/10 text-amber-400 border-amber-500/20',
  'Workflow': 'bg-rose-500/10 text-rose-400 border-rose-500/20',
  'Global': 'bg-white/5 text-white/50 border-white/10',
}

export function ToolCatalog() {
  return (
    <section id="nastroje" className="py-24 md:py-32">
